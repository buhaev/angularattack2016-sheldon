...
* `git clone git@github.com:rumblex/angularattack2016-sheldon.git`

* `cd angularattack2016-sheldon`
...
If you receive an error message `"You do not have permission to publish to sheldon.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add glibin.v@gmail.com,fanual@mail.ru,isnifer@gmail.com,st.geass@gmail.com`
